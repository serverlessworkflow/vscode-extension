...
/***/ "./node_modules/copy-paste/index.js":
/*!******************************************!*\
  !*** ./node_modules/copy-paste/index.js ***!
  \******************************************/
...
var execSync = (function() {
	if(child_process.execSync) { // Use native execSync if avaiable
		...
		try { // Try using fallback package if available
			var execSync = __webpack_require__(/*! sync-exec */ "./node_modules/sync-exec/js/sync-exec.js");
...
switch(process.platform) {
	case "darwin":
		config = __webpack_require__(/*! ./platform/darwin */ "./node_modules/copy-paste/platform/darwin.js");
		break;
	case "win32":
		config = __webpack_require__(/*! ./platform/win32 */ "./node_modules/copy-paste/platform/win32.js");
		break;
	case "linux":
		config = __webpack_require__(/*! ./platform/linux */ "./node_modules/copy-paste/platform/linux.js");
		break;
	case "freebsd":
		config = __webpack_require__(/*! ./platform/linux */ "./node_modules/copy-paste/platform/linux.js");
		break;
	case "openbsd":
		config = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module './platform/openbsd'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
		break;
	default:
...
/***/ "./node_modules/copy-paste/platform/darwin.js":
/*!****************************************************!*\
  !*** ./node_modules/copy-paste/platform/darwin.js ***!
  \****************************************************/
/*! no static exports found */
...
/***/ "./node_modules/copy-paste/platform/linux.js":
/*!***************************************************!*\
  !*** ./node_modules/copy-paste/platform/linux.js ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./node_modules/copy-paste/platform/win32.js":
/*!***************************************************!*\
  !*** ./node_modules/copy-paste/platform/win32.js ***!
  \***************************************************/
/*! no static exports found */
 ...
 */
try {
  var location = __webpack_require__(/*! ./location */ "./node_modules/phantomjs-prebuilt/lib/location.js")
...
var getPromise = __webpack_require__(/*! ./_promise.js */ "./node_modules/pn/_promise.js");
...
var fs = __webpack_require__(/*! fs */ "fs");
var promisify = __webpack_require__(/*! ./_promisify.js */ "./node_modules/pn/_promisify.js");
...
/***/ "./node_modules/svgexport sync recursive":
/*!*************************************!*\
  !*** ./node_modules/svgexport sync ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
webpackEmptyContext.id = "./node_modules/svgexport sync recursive";

/***/ }),

/***/ "./node_modules/svgexport/index.js":
/*!*****************************************!*\
  !*** ./node_modules/svgexport/index.js ***!
  \*****************************************/
/*! no static exports found */
...
var fs = __webpack_require__(/*! fs */ "fs");
var child_process = __webpack_require__(/*! child_process */ "child_process");
var phantomjs = __webpack_require__(/*! phantomjs-prebuilt */ "./node_modules/phantomjs-prebuilt/lib/phantomjs.js");
...
function render(data, done) {
  ...
  if (typeof data === 'string') {
    ...
    try {
      data = __webpack_require__("./node_modules/svgexport sync recursive")(data);
    } catch (e) {
...
(function() {
  ...
  timeout = __webpack_require__(/*! ./timeout */ "./node_modules/sync-exec/js/lib/timeout.js");
...
(function() {
  ...
  child_process = __webpack_require__(/*! child_process */ "child_process");
...
(function() {
  ...
  create_pipes = __webpack_require__(/*! ./lib/create-pipes */ "./node_modules/sync-exec/js/lib/create-pipes.js");

  proxy = __webpack_require__(/*! ./lib/proxy */ "./node_modules/sync-exec/js/lib/proxy.js");

  read_pipes = __webpack_require__(/*! ./lib/read-pipes */ "./node_modules/sync-exec/js/lib/read-pipes.js");

  timeout = __webpack_require__(/*! ./lib/timeout */ "./node_modules/sync-exec/js/lib/timeout.js");
...
/***/ "./src/commands/exportByCanvas.ts":
/*!****************************************!*\
  !*** ./src/commands/exportByCanvas.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const vscode = __webpack_require__(/*! vscode */ "vscode");
const exportProvider_1 = __webpack_require__(/*! ../exportProvider */ "./src/exportProvider.ts");
...
const svgexport = __webpack_require__(/*! svgexport */ "./node_modules/svgexport/index.js");
const fs = __webpack_require__(/*! pn/fs */ "./node_modules/pn/fs.js");
const cp = __webpack_require__(/*! copy-paste */ "./node_modules/copy-paste/index.js");
const svgProvider_1 = __webpack_require__(/*! ../svgProvider */ "./src/svgProvider.ts");
function saveFileAs(uri) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (svgProvider_1.SvgDocumentContentProvider.checkNoSvg(textDocument))
            return;
        const text = svgProvider_1.SvgDocumentContentProvider.addNamespace(textDocument.getText());
...
function showPreview(webviewManager, uri) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const textDocument = yield vscode.workspace.openTextDocument(resource);
        vscode.window.showInformationMessage(textDocument.fileName);
...
class Configuration {
    ...
    static diagramserviceurl() {
        return vscode.workspace.getConfiguration('swdiagram').get('diagramserviceurl');
    }
    static showTransGrid() {
        return vscode.workspace.getConfiguration('swdiagram').get('transparencygrid');
    }
    static transparencyColor() {
        return vscode.workspace.getConfiguration('swdiagram').get('transparencycolor');
    }
    static enableAutoPreview() {
        return vscode.workspace.getConfiguration('swdiagram').get('enableautopreview');
    }
    static enableAutoInsertNamespace() {
        return vscode.workspace.getConfiguration('swdiagram').get('autoInsertNamespace');
    }
}
...
const showPreview_1 = __webpack_require__(/*! ./commands/showPreview */ "./src/commands/showPreview.ts");
const exec = __webpack_require__(/*! child_process */ "child_process");
const fs = __webpack_require__(/*! pn/fs */ "./node_modules/pn/fs.js");
const path = __webpack_require__(/*! path */ "path");
const phantomjs = __webpack_require__(/*! phantomjs-prebuilt */ "./node_modules/phantomjs-prebuilt/lib/phantomjs.js");
const svgWebviewManager_1 = __webpack_require__(/*! ./features/svgWebviewManager */ "./src/features/svgWebviewManager.ts");
const saveFile_1 = __webpack_require__(/*! ./commands/saveFile */ "./src/commands/saveFile.ts");
const exportProvider_1 = __webpack_require__(/*! ./exportProvider */ "./src/exportProvider.ts");
const exportByCanvas_1 = __webpack_require__(/*! ./commands/exportByCanvas */ "./src/commands/exportByCanvas.ts");
...
const vscode = __webpack_require__(/*! vscode */ "vscode");
const path = __webpack_require__(/*! path */ "path");
const svgPreview_1 = __webpack_require__(/*! ./svgPreview */ "./src/features/svgPreview.ts");
const fs = __webpack_require__(/*! pn/fs */ "./node_modules/pn/fs.js");
...
/***/ "./src/features/svgWebviewManager.ts":
/*!*******************************************!*\
  !*** ./src/features/svgWebviewManager.ts ***!
  \*******************************************/
/*! no static exports found */
...
const vscode = __webpack_require__(/*! vscode */ "vscode");
const svgPreview_1 = __webpack_require__(/*! ./svgPreview */ "./src/features/svgPreview.ts");
const svgExport_1 = __webpack_require__(/*! ./svgExport */ "./src/features/svgExport.ts");
...
<link rel="stylesheet" href="${this.getPath('media/preview.css')}" type="text/css"></style>
    ...
    static addNamespace(properties) {
        if (configuration_1.Configuration.enableAutoInsertNamespace()
